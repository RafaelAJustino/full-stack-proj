...
import { CreateProposal, DeleteProposal, ListProposal } from '../../../services/proposal';
            ...
            <Grid sx={{ padding: '0px 12px', overflow: 'auto' }}>
                <S.ListProposalGrid>
                    ...
                    <Grid display={'flex'} alignItems={'center'} justifyContent={'space-between'} padding={'16px 24px'}>
                        ...
                        <Grid>
                            <S.ListProposalSearch sx={{ m: 1, width: '25ch' }} variant="outlined">
                                ...
                                <Table stickyHeader>
                                    <TableHead>
                                        <TableRow style={{ height: 33 }}>
                                            ...
                                            {(getPermissionUser?.proposal?.update || getPermissionUser?.proposal?.delete) && (
                                                <S.ListProposalTableCell align={'center'}>
                                                    Ações
                                                </S.ListProposalTableCell>
                                            )}
                    ...
                    <Grid display={'flex'} alignItems={'center'} justifyContent={'space-between'} padding={'16px 24px 32px 24px'}>
                        <Typography>
                            Mostrando {page} de {rowsPerPage > countProposal ? countProposal : rowsPerPage} de um total de {countProposal}
                        </Typography>
                        <Stack spacing={2}>
                            <Pagination
                        ...
                        <Grid container spacing={3} alignItems='flex-start' sx={{
                            ...
                            <MyGrid item xs={12}>
                                <FormControl fullWidth>
                                    ...
                                    {Boolean(formik.touched.clientId && formik.errors.clientId) && (
                                        <FormHelperText error style={{ marginLeft: 0, }}>
